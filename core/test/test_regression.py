...
class TestComputeRegressionCoefficients1(hunitest.TestCase):
    ...
    def test1(self) -> None:
        ...
        actual = coregres.compute_regression_coefficients(
            df,
...
class TestComputeRegressionCoefficients2(hunitest.TestCase):
    ...
    def test2(self) -> None:
        ...
        unweighted_actual = coregres.compute_regression_coefficients(
            df_unweighted,
            x_cols=list(range(1, 5)),
            y_col=0,
        )
        ...
        weighted_actual = coregres.compute_regression_coefficients(
            df_uniform_weights,
            x_cols=list(range(1, 5)),
            y_col=0,
    ...
    def test3(self) -> None:
        ...
        weights1_actual = coregres.compute_regression_coefficients(
            df_weights1,
            x_cols=list(range(1, 5)),
            y_col=0,
            sample_weight_col="weight",
        ...
        weights2_actual = coregres.compute_regression_coefficients(
            df_weights2,
            x_cols=list(range(1, 5)),
            y_col=0,
            sample_weight_col="weight",
